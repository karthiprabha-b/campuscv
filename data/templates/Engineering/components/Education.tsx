...
export default function Education() {
  ...
  return (
    <section id="education" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 bg-cyber-lightBg wave-top-curve wave-bottom-curve relative">
            ...
            >
              <div className="space-y-5 sm:space-y-6">
                ...
                <div className="flex flex-wrap items-start justify-between gap-3 pb-4 border-b border-slate-100">
                  ...
                  <div className="px-3.5 py-1 bg-cyber-100 text-cyber-800 rounded-full text-xs font-mono font-bold">
                    {item.period}
                  </div>
                </div>
                ...
                {/* Degree & Honors */}
                <div>
                  <span className="px-3 py-1 bg-cyber-50 text-cyber-700 rounded-full text-xs font-mono font-bold uppercase">
                    {item.field}
                  </span>
                  <h4 className="text-xl sm:text-2xl font-black font-display text-slate-900 mt-2">
                    {item.degree}
                  </h4>
