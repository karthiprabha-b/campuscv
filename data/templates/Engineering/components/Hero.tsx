...
import { Github, Linkedin, ArrowRight, Cpu, Layers, Sparkles, Shield } from 'lucide-react';
          ...
          <div className="lg:col-span-6 flex justify-center lg:justify-end relative">
            ...
            <div className="relative w-[260px] sm:w-[340px] md:w-[380px] h-[400px] sm:h-[500px] md:h-[540px] rounded-full overflow-hidden border-4 sm:border-[6px] border-white/20 shadow-deep-float bg-cyber-900 p-2">
              <div className="relative w-full h-full rounded-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-cyber-950/40 via-transparent to-transparent pointer-events-none"></div>
              </div>
            </div>
