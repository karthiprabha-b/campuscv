...
export default function Template(props = {}) {
  ...
  rawOrder.forEach((rawItem) => {
    ...
    else if (s.includes('proj') || s.includes('work') || s.includes('portfolio')) id = 'projects';
    else if (s.includes('exp') || s.includes('career') || s.includes('timeline')) id = 'experience';
    else if (s.includes('skill') || s.includes('tech') || s.includes('stack') || s.includes('tool')) id = 'skills';
