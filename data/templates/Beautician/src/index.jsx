...
export default function BeauticianTemplate({ data = {} }) {
  ...
  rawOrder.forEach((rawItem) => {
    ...
    else if (s.includes('proj') || s.includes('work') || s.includes('portfolio') || s.includes('service') || s.includes('gallery')) id = 'projects';
    else if (s.includes('exp') || s.includes('career') || s.includes('timeline')) id = 'experience';
    else if (s.includes('skill') || s.includes('tech') || s.includes('tool') || s.includes('treat')) id = 'skills';
    ...
    else if (s.includes('contact') || s.includes('touch') || s.includes('book') || s.includes('social')) id = 'contact';
