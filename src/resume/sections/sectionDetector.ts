...
export const SECTION_PATTERNS: Record<string, RegExp> = {
  ...
  CERTIFICATIONS: /^(?:Certifications?|Certificates?|Courses?|Licenses?|Credentials?|Honors?|Achievements & Certifications|Professional Certifications|Trainings?|Honors & Certifications|Licenses & Certificates|Certificates & Licenses|Certifications & Licenses|Licenses and Certifications|Certifications and Licenses|Courses & Certifications|Courses and Certifications|Professional Credentials|Certifications & Achievements|Certificates & Achievements|Certifications & Awards|Awards & Certifications|Certificates & Awards|Coursework & Certifications|Workshops? & Certifications?|Industrial Training & Certifications?|Key Certifications?|Online Certifications?|Relevant Certifications?|Certifications & Badges|Accreditations?|Certificates \/ Courses|Courses \/ Certifications)$/i,
  ACHIEVEMENTS: /^(?:Achievements?|Awards?|Honors?|Accomplishments?|Awards & Honors|Recognitions?|Honors & Awards|Extracurricular Activities|Co-curricular Activities|Achievements & Awards|Key Achievements|Notable Achievements)$/i,
