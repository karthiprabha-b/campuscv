...
const TEMPLATE_SECTION_DEFAULTS: Record<string, string[]> = {
  ...
  'stu_lawyer': ['hero', 'achievements', 'about', 'skills', 'projects', 'services', 'experience', 'education', 'certifications', 'testimonials', 'contact'],
  'stu-lawyer': ['hero', 'achievements', 'about', 'skills', 'projects', 'services', 'experience', 'education', 'certifications', 'testimonials', 'contact'],
  'stu lawyer': ['hero', 'achievements', 'about', 'skills', 'projects', 'services', 'experience', 'education', 'certifications', 'testimonials', 'contact'],
  'lawyer': ['hero', 'achievements', 'about', 'skills', 'projects', 'services', 'experience', 'education', 'certifications', 'testimonials', 'contact'],
  'executive-lawyer-portfolio': ['hero', 'achievements', 'about', 'skills', 'projects', 'services', 'experience', 'education', 'certifications', 'testimonials', 'contact'],
  'executive lawyer': ['hero', 'achievements', 'about', 'skills', 'projects', 'services', 'experience', 'education', 'certifications', 'testimonials', 'contact'],
