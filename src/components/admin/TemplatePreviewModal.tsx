...
export default function TemplatePreviewModal({ template, isOpen, onClose }: TemplatePreviewModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-zinc-950/95 backdrop-blur-md flex flex-col justify-between animate-fadeIn">
      {/* Top Controls Bar */}
      <header className="px-6 py-3 bg-zinc-900 border-b border-zinc-800 text-white flex items-center justify-between text-xs z-50">
        <div className="flex items-center gap-3">
          <span className="font-extrabold text-sm text-[#7C3AED] flex items-center gap-1.5">
          ...
          <span className="text-zinc-500 font-mono text-[10px]">ID: {template.id}</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            {useUserData ? <UserCheck className="w-3.5 h-3.5" /> : <Database className="w-3.5 h-3.5" />}
            <span>{useUserData ? 'Active User Data' : 'Sample Demo Data'}</span>
          </button>
          ...
          <div className="flex items-center gap-1 bg-zinc-800 p-1 rounded-xl">
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors ${device === 'desktop' ? 'bg-[#7C3AED] text-white' : 'text-zinc-400 hover:text-white'}`}
            ...
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors ${device === 'tablet' ? 'bg-[#7C3AED] text-white' : 'text-zinc-400 hover:text-white'}`}
            ...
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors ${device === 'mobile' ? 'bg-[#7C3AED] text-white' : 'text-zinc-400 hover:text-white'}`}
          ...
          <div className="flex items-center gap-1 bg-zinc-800 p-1 rounded-xl">
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors ${themeMode === 'light' ? 'bg-amber-500 text-white' : 'text-zinc-400 hover:text-white'}`}
            ...
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors ${themeMode === 'dark' ? 'bg-[#7C3AED] text-white' : 'text-zinc-400 hover:text-white'}`}
          ...
          {/* Zoom Scale Controls */}
          <div className="flex items-center gap-1 bg-zinc-800 p-1 rounded-xl font-mono text-[11px]">
            <button
