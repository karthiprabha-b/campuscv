  ...
  return (
    <aside className="w-[260px] bg-white border-r border-gray-200 flex flex-col justify-between h-screen sticky top-0 flex-shrink-0 z-30 select-none">
      ...
      <div className="p-5 flex flex-col gap-5 overflow-y-auto">
        {/* Brand Header */}
        <div className="flex items-center gap-3 px-1 py-1 cursor-pointer group" onClick={() => onSectionClick("hero")}>
          <div 
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-between px-3.5 py-2.5 rounded-lg text-sm font-semibold transition-all text-left group cursor-pointer ${
                  isActive
