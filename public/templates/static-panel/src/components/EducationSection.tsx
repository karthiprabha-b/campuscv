...
export default function EducationSection({ data = {} }: EducationSectionProps) {
  ...
  return (
    <section id="education" data-cv-section="education" data-node-id="section:education:root:section:0" className="py-12 sm:py-16 border-b border-gray-200/80 scroll-mt-8">
      <div className="mb-8">
